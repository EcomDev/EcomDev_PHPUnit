...
abstract class EcomDev_PHPUnit_Test_Case extends PHPUnit_Framework_TestCase
{
        ...
        $callOriginalClone = true, $callAutoload = true)
    {
        ...
        return $this->getAccessibleMock($className, $methods, $constructorArguments, $mockClassAlias,
     ...
     * @return object
     */
    protected function getAccessibleMock($originalClassName, $methods = array(), array $arguments = array(),
        $mockClassName = '', $callOriginalConstructor = TRUE,
        $callOriginalClone = TRUE, $callAutoload = TRUE)
    {
        return $this->getMock($this->buildAccessibleProxy($originalClassName), $methods, $arguments,
